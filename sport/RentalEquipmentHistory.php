...
<head>
    ...
    <link rel="stylesheet" href="css/RentalEquipmentHistory.css">
...
<?php
        ...
        $query = "SELECT * FROM equipmentrental";
        if ($selectedDate) {
            $query .= " WHERE rentDate = '$selectedDate'";
        }
        ...
        echo '<button  class="btn btn-primary" type="submit" value="Filter">Filter</button>';
        echo '</form>';
        ...
        if (!$anyData) {
            echo '<p style="color:red;margin-left:800px;margin-top:200px">No Rental For This Date</p>';
        }
        echo '</table>';
